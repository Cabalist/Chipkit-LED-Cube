...
void Helicopter() {
    ...
    // top layer
    heli.description[0][0][0] = White; // 1st column,  6 panels
    ...
    heli.description[0][1][0] = Black; // 2nd column,  6 panels
    ...
    heli.description[0][2][0] = Black; // 3rd column,  6 panels
    ...
    heli.description[0][3][0] = Black; // 4th column,  6 panels
    ...
    heli.description[0][4][0] = Black; // 5th column,  6 panels
    ...
    heli.description[0][5][0] = Black; // 6th column,  6 panels
