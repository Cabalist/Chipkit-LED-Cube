/* This tab contains a color table which has 8 colors of the rainbow plus black and white in 5 different intensities.  
   ...
   So data is the Red, Green, and Blue intensities from 0 to 63 for eaah color and intensity.
   ...
   green (color 4) at intensiy 2, which in this particular case are 0,15,0 for red, green, and blue.  
*/
byte colors[50][3] ={
  {
  ...
  {
    0,  0, 0    }
  ,                  // These next 10 entries are for intensity 1.  BAM comonents total 5 or 6:
  {
    0,  0, 0    }    // Black or all off
  ,
  {                 
    5,  0, 0    }    // Red
  ,
