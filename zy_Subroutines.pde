/* There are a whole bunch subroutines here:
 ...
 5) The scrollText sub lets you specify a string of text to be scrolled, specify its 3 RGB color components,
    and whether to display on 2 or 4 faces of the cube. 
 6) The scrollThruX sub lets you specify a string of text to be scrolled, specify its 3 RGB color components,
 ...
 7) The scrollThruY sub lets you specify a string of text to be scrolled, specify its 3 RGB color components,
 ...
 10) The rotate sub lets you specify a string of text to be used, specify its 3 RGB color components,
